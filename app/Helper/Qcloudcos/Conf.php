...
namespace App\Helper\Qcloudcos;
...
class Conf {
    ...
    const APP_ID = '1253292603';
    const SECRET_ID = 'AKIDVuAGDzlzDF6oMigukOr9KK8iCZptxU2b';
    const SECRET_KEY = 'iJjxzpUxX5WlpjR1QfjcJvNdibJpBLK8';
