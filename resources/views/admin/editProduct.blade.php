...
<div class="layui-body layui-tab-content site-demo-body">
	<div class="info_box" id="edit_product" v-cloak>
			...
			<table class="layui-table">
				...
				<tbody>
					...
					<tr v-if="req.type==1">
						...
						<td class="tc" v-if="req.send_sms_or_not==1"><input type="text" class="layui-input" v-model="req.booking_information"></td>-->
					</tr>
					<tr v-if="req.type==1">
...
<script src="{{statics('js/admin/edit_product.js')}}"></script>
