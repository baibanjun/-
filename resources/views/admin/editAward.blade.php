...
<div class="layui-body layui-tab-content site-demo-body">
	<div class="info_box" id="edit_award" v-cloak>
		...
		<div class="pl30 mg10" style="width: 90%">
			...
			<table class="layui-table">
				...
				<tbody>
					<tr>
						...
						<td class="tc">@{{req.lottery_type==1?'九宫格抽奖':'圆盘抽奖'}}</td>
					</tr>
					<tr>
			...
			<div class="mg20">
				...
				<table class="layui-table" v-for="(n,index) in req.draw_data" style="margin-top: 30px;">
					...
					<tr v-if="req.draw_data[index].draw_type==1">
						...
						<td class="tc">
							<input type="text" class="layui-input" style="width: 45%;display: inline-block;" :id="'start_time_'+index" placeholder="开始时间" :value="req.draw_data[index].start_date"> --
							<input type="text" class="layui-input" style="width: 45%;display: inline-block;" :id="'end_time_'+index" placeholder="结束时间" :value="req.draw_data[index].end_date">
						</td>
			...
			<!--提交-->
			<p class="mg20 tc">
				<button class="layui-btn layui-btn-normal" @click="post()">提交保存</button>
...
<script src="{{statics('js/admin/edit_award.js')}}"></script>
