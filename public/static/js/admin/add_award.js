new Vue({
    ...
    created: function () {
        var ddd = /^(([0-9]+\.[0-9]*[0-9][0-9]*)|([0-9]*[0-9][0-9]*\.[0-9]+)|([0-9]*[0-9][0-9]*))$/;
        console.log(ddd.test('-1'));
    ...
    methods: {
        post: function () {
            ...
            for (var i = 0; i < _self.req.draw_data.length; i++) {
                ...
                if (n.pic.length == 0 && _self.q_is_pic_show) {
                    layer.msg('请上传奖品图片');
                    _pass = false;
                    return false;
                }
        ...
        choose_type: function (event) {
            ...
            if (event.target.value == 1) {
                _self.q_is_pic_show = true;
                if (_self.req.draw_data.length == 6) {
